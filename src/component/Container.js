    ...
    useEffect(() => {
          const fetchApi = async() => {
            ...
            setDate(date);
                ...
                const url = `https://api.openweathermap.org/data/2.5/weather?q=${search}&appid=d765d356ebd7e11900c84780738686b3`;
...
{city === null  ? (<div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                ...
                <div className="px-6 py-6 relative">
                    <div className="flex mb-4 justify-between items-center">
                        <div>
                            ...
                            <h6 className="mb-0">{date}</h6><small>{city.weather[0].main}</small>
                        </div>
